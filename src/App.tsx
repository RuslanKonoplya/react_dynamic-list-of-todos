...
export const App: React.FC = () => {
  ...
  const [sortFilter, setSortFilter] = useState<SortFilter>({ select: "all", textSearch: "" });
        ...
        <div className="container">
          <div className="box">
            ...
            <div className="block">
              ...
              {load ? (
                <Loader />) :
                (<TodoList todos={preparedTodos} setModalIsOpen={setModalIsOpen} setSelectTodo={setSelectTodo} modalIsOpen={ modalIsOpen} />) }
